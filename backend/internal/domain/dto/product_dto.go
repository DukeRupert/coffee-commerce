...
func (p *ProductCreateDTO) ToModel() *model.Product {
...
func (dto *ProductUpdateDTO) ApplyToModel(product *model.Product) {
	if dto.Name != nil {
...
func ProductResponseDTOFromModel(product *model.Product) ProductResponseDTO {
