	...
	>
		...
		<div class="fixed inset-0 flex">
			...
			>
				...
				<div
					class="absolute top-0 left-full flex w-16 transform justify-center pt-5 transition duration-300 ease-in-out"
					class:opacity-100={isMobileSidebarOpen}
					class:opacity-0={!isMobileSidebarOpen}
				>
						...
						<ul role="list" class="flex flex-1 flex-col gap-y-7">
							<li>
								<ul role="list" class="-mx-2 space-y-1">
									...
									<!-- Other navigation items (same as in template) -->
									<!-- Team -->
									<li>
										<a
											href="#"
				...
				<ul role="list" class="flex flex-1 flex-col gap-y-7">
					<li>
						<ul role="list" class="-mx-2 space-y-1">
							...
							<!-- Other desktop menu items (same structure as mobile) -->
							<!-- Team -->
							<li>
								<a
									href="#"
		...
		>
            ...
            -->
						{#if isUserMenuOpen}
							<div
								id="user-menu"
								class="absolute right-0 z-10 mt-2.5 w-32 origin-top-right rounded-md bg-white py-2 shadow-lg ring-1 ring-gray-900/5 transition duration-100 ease-out focus:outline-hidden"
